        ...
        <div  className={`min-w-screen min-h-screen relative`}>
            <div className='w-screen h-screen overflow-hidden fixed top-0 left-0'>
                <div className="absolute w-screen h-[50%] md:w-[30%] md:h-full bg-cream dark:bg-cream-dark top-[0%] md:top-0 left-0 z-0 overflow-hidden" >
                    {/* <img src={Letters2} alt={"Hungry Joes"} className='opacity-30 w-[50%] left-[-5%] top-[-20%] h-fit max-w-[1000vw] fixed' /> */}
                    <LetterTexture fill={"#2B0200"} className={'opacity-100  h-[150%] md:h-[115%] w-fit left-[-5%] md:left-[-2.5%] top-[-10%] max-w-[1000vw] fixed'} />
                    {/* <div
                        style={{height:`${35*squares.length}px`}}
                        className='w-[35px] bottom-0 fixed'
                    >
                        {squares.map((square => (
                            <div
                                style={{backgroundColor:square}}
                                key={square}
                                className={`w-[105px] h-1/5 relative left-[-70px] hover:translate-x-[40px] transition-all`}
                            />
                        )))}
                    </div> */}
                </div>
                <div className="absolute w-screen md:w-[70%] h-[50%] md:h-full top-1/2 md:top-[0%] right-0 z-0 isolate overflow-hidden">
                    ...
                    <div className='z-10 absolute bg-beef box-border pt-[40%] grid place-items-center w-[150%] h-[150%] top-[-50%] left-[-25%]'>
                        ...
                        {/* Logo on the botton left corner */}
                    ...
                    { /* Light background with animation and letters*/}
                    <div
                    ...
                    { /* Burger picture in the middle of screen */}
                    <img
            ...
            <form style={{backdropFilter:"blur(10px)"}} className="relative w-[90vw] ml-auto mr-auto md:mr-0 max-w-[450px] md:w-[450px] h-fit bg-white bg-opacity-80 z-10 md:ml-[3vw] xl:ml-[6vw] 2xl:ml-[10.5vw] top-[15vh] md:top-[10vh] xl:top-[14vh] 2xl:top-[18vh] rounded-2xl px-8 pt-14 pb-10 flex flex-col gap-8">
                ...
                <Input type={"text"} className={"w-full grow text-beef"} placeHolder={"Table Number"} />
                <Input type={"password"} className={"w-full grow text-beef"} placeHolder={"Password"} />
